...
const { cadastrarCliente, editarClientePorID, listarClientes, detalharClientePorID } = require('./controladores/clientes');
...
rotas.put('/cliente/:id', validarCorpoRequisicao(schemaCliente), editarClientePorID);
